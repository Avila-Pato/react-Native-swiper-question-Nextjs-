      ...
      >
        <Animated.View style={[styles.header, titleStyle]}>
          <Text style={styles.title}>
            ...
            <Text style={{ color: "#34D59A" }}>partida</Text>
          </Text>
          ...
          {CAREERS.map((career, i) => (
            <Animated.View key={career.id} style={cardAnimStyles[i]}>
              ...
              >
                ...
                >
                  <Ionicons name={career.icon} size={22} color={GREEN} />
                </View>
...
const styles = StyleSheet.create({
  ...
  cardSelected: {
    borderColor: GREEN,
    backgroundColor: "rgba(52,213,154,0.06)",
  },
  cardIcon: {
    width: 44,
    height: 44,
    borderRadius: 10,
    backgroundColor: "rgba(52,213,154,0.1)",
    justifyContent: "center",
    alignItems: "center",
  },
  cardIconSelected: {
    backgroundColor: "rgba(52,213,154,0.18)",
  },
  cardText: {
    flex: 1,
  },
