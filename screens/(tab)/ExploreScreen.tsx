...
const LAYOUTS: Record<Category, () => React.JSX.Element> = {
  Todo: LayoutTodo,
  Destacado:       () => <CategoryLayout newsCategory="general"     sort="popularity"      areaLabel="Destacado" />,
  "Último hora":   () => <CategoryLayout newsCategory="technology"  sort="published_desc"  areaLabel="Último hora" />,
  "Lo más leído":  () => <CategoryLayout newsCategory="business"    sort="popularity"      areaLabel="Lo más leído" />,
};
